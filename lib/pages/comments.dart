        ...
        builder: (BuildContext context) {
          return SimpleDialog(
            ...
            children: <Widget>[
              ...
              Text('Want to delete this item from the comment sectione?',
                  style: TextStyle(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            Padding(
              padding: EdgeInsets.only(right: 1320.0),
              child: GestureDetector(
                  onTap: () {},
                  child: IconButton(
                    icon: Image.network(
                        'http://atlas-content-cdn.pixelsquid.com/stock-images/reload-icon-computer-K60K0R2-600.jpg'),
                    onPressed: () async {
                      reloadData();
                    },
          ...
          widget: Column(
            children: <Widget>[
              ...
              Divider(
                ...
                indent:
                    20, //?This attribute lets you define the indent/space to be given on the left side of the Divider. It determines the space in terms of double value
                endIndent: 20,
              ),
              SafeArea(
                child: Container(
