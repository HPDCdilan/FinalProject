      ...
      if (ab.userType == 'tester') {
        ...
        await getTimestamp()
            .then((value) => context
                ...
                .sendNotification(titleCtrl.text))
            .then((value) => context.read<NotificationBloc>().saveToDatabase(
                timestamp, titleCtrl.text, descriptionCtrl.text, date))
            .then((value) =>
                context.read<AdminBloc>().increaseCount('notifications_count'))
            .then((value) => openToast1(context,
                'Sent Successfully! Refresh by pull down to see new data'));
        Navigator.pop(context);
      }
    }
  }
