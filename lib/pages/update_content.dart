...
class _UpdateContentState extends State<UpdateContent> {
    ...
    if (categorySelection == null) {
      ...
      if (formKey.currentState.validate()) {
        ...
        if (ab.userType == 'tester') {
          ...
          openDialog(context, 'Artical Updated Successfully',
              'Your artical is updated');
        }
      }
    }
  }
  ...
  Future updateDatabase() async {
    final DocumentReference ref =
        firestore.collection('contents').doc(widget.data.timestamp);
    _articleData = {
        ...
        widget: Form(
            ...
            child: ListView(
              children: <Widget>[
                ...
                Center(
                  child: Text(
                    'Update Article Content Details',
                ...
                Row(
                  children: [
                    ...
                    Text(
                        'To create Description with STYLS write description with HTML tags'),
                    IconButton(
                      icon: Image.network(
